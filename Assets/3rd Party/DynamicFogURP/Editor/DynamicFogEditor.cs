...
namespace DynamicFogAndMist2 {
    ...
    public partial class DynamicFogEditor : Editor {
        ...
        SerializedProperty enableFade, fadeDistance, fadeController, showBoundary;
        ...
        public override void OnInspectorGUI() {
            ...
            EditorGUILayout.PropertyField(enableFade, new GUIContent("Enable Fade", "Fades in/out fog effect when reference object enters the fog volume."));
            if (enableFade.boolValue) {
                EditorGUI.indentLevel++;
                EditorGUILayout.PropertyField(fadeDistance);
                EditorGUILayout.PropertyField(fadeController, new GUIContent("Controller", "Specifies the object to enter the fog volume."));
                EditorGUI.indentLevel--;
            }
